...
| A dead worker's row returns in bounded time (NFR-4)       | lease expiry                                                                   | reclaim test measuring time-to-claim after the holder vanishes; asserts **both** bounds — not before expiry, and within one tick after            |
